...
Shader "BoxClip/Particles/Standard Unlit"
{
    Properties
    {
    ...
    Category
    {
        SubShader
        {
            Tags { "RenderType"="Opaque" "IgnoreProjector"="True" "PreviewType"="Plane" "PerformanceChecks"="False" "DisableBatching"="True" }
    ...
    ENDCG
        ...
        #ifdef V2F_SHADOW_CASTER_NOPOS_IS_EMPTY
        #undef V2F_SHADOW_CASTER_NOPOS_IS_EMPTY
        #endif
		...
		#include "BoxClipStandardShadow.cginc"
            ...
            Pass
            {
                ...
                #pragma geometry boxGeom
                #pragma fragment boxFrag
                VertexOutput vertParticleUnlitStub(appdata_particles v) {
                    VertexOutput o;
                    vertParticleUnlit(v, o);
                    return o;
                }
                BOXCLIP_ALL_SHADERS_NOPOS(fragParticleUnlit, VertexOutput, vertParticleUnlitStub, appdata_particles)
